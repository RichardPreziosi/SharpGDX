 ...
 * set per window via {@link DesktopApplicationConfiguration} and {@link DesktopWindowConfiguration}. Close events can be canceled
 * by returning false.
 * 
 * @author badlogic */
	public interface DesktopWindowListener
	{

		/** Called after the GLFW window is created. Before this callback is received, it's unsafe to use any {@link DesktopWindow}
		 ...
		 * {@link DesktopApplication#DesktopApplication(ApplicationListener, DesktopApplicationConfiguration)}.
		 *
		 * @param window the window instance
		 *
		 * @see DesktopApplication#newWindow(ApplicationListener, DesktopWindowConfiguration) */
		 ...
		 * {@link DesktopGraphics#requestRendering()} is automatically called. */
