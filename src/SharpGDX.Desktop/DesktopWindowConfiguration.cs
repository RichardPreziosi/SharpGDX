...
namespace SharpGDX.Desktop
{
	public class DesktopWindowConfiguration
	{
		...
		internal DesktopWindowListener windowListener;
		...
		public void setWindowListener(DesktopWindowListener windowListener)
		{
		...
		/** Sets whether to use vsync. This setting can be changed anytime at runtime via {@link Graphics#setVSync(bool)}.
		 *
