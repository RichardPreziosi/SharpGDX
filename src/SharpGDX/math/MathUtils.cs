 ...
 * @author Nathan Sweet */
	public static class MathUtils
	{
		...
		private const float radFull = PI2;
	...
	public static float tan(float radians)
	{
		radians /= PI;
		radians += 0.5f;
		radians -= (float)System.Math.Floor(radians);
		radians -= 0.5f;
		radians *= PI;
	...
	public static float tanDeg(float degrees)
	{
		degrees *= (1f / 180f);
		degrees += 0.5f;
		degrees -= (float)System.Math.Floor(degrees);
		degrees -= 0.5f;
		degrees *= PI;
	...
	public static float atanUnchecked(double i)
	{
		...
		double c9 = c7 * c2;
		double c11 = c9 * c2;
		return (float)(System.Math.Sign(i) * ((System.Math.PI * 0.25)
	...
	public static double atanUncheckedDeg(double i)
	{
		...
		double c9 = c7 * c2;
		double c11 = c9 * c2;
		return (System.Math.Sign(i) * (45.0 + (57.2944766070562 * c - 19.05792099799635 * c3 + 11.089223410359068 * c5
	...
	/** Returns acos in radians; less accurate than System.Math.Acos but may be faster. Average error of 0.00002845 radians (0.0016300649
	 * degrees), largest error of 0.000067548 radians (0.0038702153 degrees). This implementation does not return NaN if given an
	 * out-of-range input (System.Math.Acos does return NaN), unless the input is NaN.
	...
	static public float acos(float a)
	{
		...
		if (a >= 0f)
		{
			return (float)System.Math.Sqrt(1f - a) * (1.5707288f - 0.2121144f * a + 0.0742610f * a2 - 0.0187293f * a3);
		}
		return 3.14159265358979323846f
			- (float)System.Math.Sqrt(1f + a) * (1.5707288f + 0.2121144f * a + 0.0742610f * a2 + 0.0187293f * a3);
	}

	/** Returns asin in radians; less accurate than System.Math.Asin but may be faster. Average error of 0.000028447 radians (0.0016298931
	 * degrees), largest error of 0.000067592 radians (0.0038727364 degrees). This implementation does not return NaN if given an
	 * out-of-range input (System.Math.Asin does return NaN), unless the input is NaN.
	...
	static public float asin(float a)
	{
		...
		return -1.5707963267948966f + (float)System.Math.Sqrt(1f + a) * (1.5707288f + 0.2121144f * a + 0.0742610f * a2 + 0.0187293f * a3);
	}
	...
	public static float atan(float i)
	{
		...
		double n = System.Math.Min(System.Math.Abs(i), double.MaxValue);
		// c uses the "equally-good" formulation that permits n to be from 0 to almost infinity.
		double c = (n - 1.0) / (n + 1.0);
		// The approximation needs 6 odd powers of c.
		double c2 = c * c;
		...
		double c9 = c7 * c2;
		double c11 = c9 * c2;
		return System.Math.Sign(i) * (float)((System.Math.PI * 0.25)
			+ (0.99997726 * c - 0.33262347 * c3 + 0.19354346 * c5 - 0.11643287 * c7 + 0.05265332 * c9 - 0.0117212 * c11));
	}

	/** Returns arcsine in degrees. This implementation does not return NaN if given an out-of-range input (System.Math.Asin does return
	...
	public static float asinDeg(float a)
	{
		...
		if (a >= 0f)
		{
			return 90f - (float)System.Math.Sqrt(1f - a)
				* (89.99613099964837f - 12.153259893949748f * a + 4.2548418824210055f * a2 - 1.0731098432343729f * a3);
		}
		return (float)System.Math.Sqrt(1f + a)
			* (89.99613099964837f + 12.153259893949748f * a + 4.2548418824210055f * a2 + 1.0731098432343729f * a3) - 90f;
	}

	/** Returns arccosine in degrees. This implementation does not return NaN if given an out-of-range input (System.Math.Acos does return
	 * NaN), unless the input is NaN.
	 * @param a acos is defined only when a is between -1f and 1f, inclusive
	...
	public static float acosDeg(float a)
	{
		...
		return 180f - (float)System.Math.Sqrt(1f + a)
			* (89.99613099964837f + 12.153259533621753f * a + 4.254842010910525f * a2 + 1.0731098035209208f * a3);
	}
	...
	public static float atanDeg(float i)
	{
		...
		double c9 = c7 * c2;
		double c11 = c9 * c2;
		return (float)(System.Math.Sign(i) * (45.0 + (57.2944766070562 * c - 19.05792099799635 * c3 + 11.089223410359068 * c5
			- 6.6711120475953765 * c7 + 3.016813013351768 * c9 - 0.6715752908287405 * c11)));
	}
	...
	static public bool eandomBoolean()
	{
		return _random.nextBoolean();
	}

	/** Returns true if a random value between 0 and 1 is less than the specified value. */
	static public bool eandomBoolean(float chance)
	{
