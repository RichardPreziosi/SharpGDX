...
public class JsonValue : IEnumerable<JsonValue> {
	...
	public JsonValue? get (String name) {
		JsonValue current = _child;
			...
			while (current != null && (current.name == null || !current._name.Equals(name, StringComparison.CurrentCultureIgnoreCase)))
			current = current._next;
		return current;
	}
	...
	private void prettyPrint (JsonValue obj, Writer writer, int indent, PrettyPrintSettings settings)// TODO: throws IOException 
	{
		throw new NotImplementedException();
