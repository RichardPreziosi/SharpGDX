 ...
 * @author mzechner */
	public class Color
	{
		...
		public static Color valueOf(String hex, Color color)
		{
			...
			color.r = int.Parse(hex.Substring(0, 2), NumberStyles.HexNumber) / 255f;
			color.g = int.Parse(hex.Substring(2, 4), NumberStyles.HexNumber) / 255f;
			color.b = int.Parse(hex.Substring(4, 6), NumberStyles.HexNumber) / 255f;
			color.a = hex.Length != 8 ? 1 : int.Parse(hex.Substring(6, 8), NumberStyles.HexNumber) / 255f;
			return color;
		}
