 ...
 * @author Tommy Ettinger */
	public class ObjectIntMap<K> : IEnumerable<ObjectIntMap<K>.Entry<K>> {
	public int size;
	...
	public IEnumerator<Entry<K>> GetEnumerator()
	{
		return entries();
	}
	...
	public IEnumerator<Entry<K>> entries()
	{
		if (Collections.allocateIterators) return new Entries<K>(this);
		if (entries1 == null)
		{
	...
	public class MapIterator<K>
	{
		...
		protected readonly ObjectIntMap<K> map;
	...
	public class Entries<K> : MapIterator<K> , IEnumerable<Entry<K>>, IEnumerator<Entry<K>> {
	...
	public class Values : MapIterator<K> {
		public Values(ObjectIntMap<K> map)
		: base((ObjectIntMap<K>)map)
			{
...
public class Keys<K> : MapIterator<K> , IEnumerable<K>, IEnumerator<K> {
