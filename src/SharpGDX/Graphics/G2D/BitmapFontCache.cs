...
public class BitmapFontCache {
	...
	private readonly Array<GlyphLayout> layouts = new ();
	private readonly Array<GlyphLayout> pooledLayouts = new ();
	...
	private void setPageCount (int pageCount) {
		...
		if (pageGlyphIndices != null) {
			...
			Array.Copy(pageGlyphIndices, 0, newPageGlyphIndices, 0, pageGlyphIndices.Length);
		}
