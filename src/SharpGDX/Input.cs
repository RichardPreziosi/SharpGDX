 ...
 * @author mzechner */
	public interface Input
	{
		...
		static public class Keys
		{
			...
			{
				if (keycode < 0) throw new ArgumentException("keycode cannot be negative, keycode: " + keycode);
				if (keycode > MAX_KEYCODE)
					throw new ArgumentException("keycode cannot be greater than 255, keycode: " + keycode);
				switch (keycode)
				{
